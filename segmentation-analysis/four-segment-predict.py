...
if __name__ == "__main__":
    ...
    for iter in range(1):
        ...
        dir_arr = [name for name in os.listdir("../output") if name.startswith("four-segment") ]
        #dir_arr = [name for name in os.listdir("/Users/mehmetpekmezci/ozu/segment-analysis") if name.startswith("four-segment") ]
        for dir_name in dir_arr:
            ...
            node_count = int(dir_name.split("-")[6])
