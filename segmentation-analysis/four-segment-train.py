...
if __name__ == "__main__":
    ...
    first_segment_length = int(os.getenv('first_segment_length', 12))
    second_segment_length = int(os.getenv('second_segment_length', 12))
    third_segment_length = int(os.getenv('third_segment_length', 12))
    fourth_segment_length = 50 - first_segment_length - second_segment_length - third_segment_length
    ...
    for iter in range(repeat_count):
        ...
        dir_name= f"../output/four-segment-{first_segment_length}-{second_segment_length}-{third_segment_length}-{fourth_segment_length}-{node_count}-{trial_id}-{iter}"
        os.mkdir(dir_name)
        segment_borders = [[0,first_segment_length],
                           [first_segment_length, first_segment_length+second_segment_length],
                           [first_segment_length+second_segment_length, first_segment_length+second_segment_length+third_segment_length],
                           [first_segment_length+second_segment_length+third_segment_length, 50]]
